...
//后续添加函数
void LCD_Show_Title(void);	//显示屏显示初始信息
void LCD_Show_lcj(void);	//显示里程计计数
void LCD_Show_v(void);		//显示轮子速度
void LCD_Show_pwm(void);	//显示PWM数值
void LCD_Show_V(void);		//显示X,Y,W速度
void LCD_Show_position(void);//显示X,Y,theta位置
