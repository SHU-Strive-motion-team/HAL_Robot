...
{ 	  
	...
	if(lcddev.id!=0X5310)		//尝试看看是不是NT35510
	{
		LCD_WR_REG(0XDA00);	
...
void LCD_Show_Title(void)						//显示内容框架
{
	...
	LCD_ShowString(30+200,260,200,16,16,"pwm1:");	
 	LCD_ShowString(30+200,280,200,16,16,"pwm2:");	
	LCD_ShowString(30+200,300,200,16,16,"pwm3:");	
	
 	LCD_ShowString(30,260,200,16,16," Yaw :          C");	 
	LCD_ShowString(30,280,200,16,16," vx ");	
	LCD_ShowString(30,300,200,16,16," vy ");	
	LCD_ShowString(30,320,200,16,16," w ");	
	LCD_ShowString(30,340,200,16,16," X ");	
...
void LCD_Show_lcj(void)
{
	...
	for(i = 0; i <= 3; i++)
	{
		tem = BasketballRobot.w[i];
		if(tem<0)
		{
			tem = -tem;
			switch(i){
				case 0:
					LCD_ShowChar(30+200+40,200,'-',16,0);
					break;
				case 1:
					LCD_ShowChar(30+200+40,220,'-',16,0);
					break;
				case 2:
					LCD_ShowChar(30+200+40,240,'-',16,0);
					break;
			}
		}
		else
		...
		switch (i){
			case 0:
				LCD_ShowxNum(30+200+60,200,integer,10,16,0);
				break;
			case 1:
				LCD_ShowxNum(30+200+60,220,integer,10,16,0);
				break;
			case 2:
				LCD_ShowxNum(30+200+60,240,integer,10,16,0);
				break;
		}
	}
}
...
void LCD_Show_pwm(void)
{
	...
	for(i = 0; i <= 3; i++)
	{
		tem = BasketballRobot.Velocity[i];
		if(BasketballRobot.Velocity[i]<0)
		{
			tem = -tem;
			switch(i){
				case 0:
					LCD_ShowChar(30+200+40,260,'-',16,0);
					break;
				case 1:
					LCD_ShowChar(30+200+40,280,'-',16,0);
					break;
				case 2:
					LCD_ShowChar(30+200+40,300,'-',16,0);
					break;
			}
		}
		else{
		...
		switch (i){
			case 0:
				LCD_ShowxNum(50+200+40,260,integer,3,16,0);
				LCD_ShowChar(75+200+40,260,'.',16,0);
				LCD_ShowxNum(86+200+40,260,decimal,3,16,0);
				break;
			case 1:
				LCD_ShowxNum(50+200+40,280,integer,3,16,0);
				LCD_ShowChar(75+200+40,280,'.',16,0);
				LCD_ShowxNum(86+200+40,280,decimal,3,16,0);
				break;
			case 2:
				LCD_ShowxNum(50+200+40,300,integer,3,16,0);
				LCD_ShowChar(75+200+40,300,'.',16,0);
				LCD_ShowxNum(86+200+40,300,decimal,3,16,0);
				break;
		}
	}
}
...
void LCD_Show_V(void)
{
	...
	tem = BasketballRobot.Vx;
	if(tem<0)
	{
		tem = -tem;
		LCD_ShowChar(60,280,'-',16,0);
	}
	else{
		LCD_ShowChar(60,280,' ',16,0);
	}
	integer = (u32)tem;
	decimal = (u32)((tem-integer)*1000);
	LCD_ShowxNum(90,280,integer,3,16,0);
	LCD_ShowChar(90+25,280,'.',16,0);
	LCD_ShowxNum(90+36,280,decimal,3,16,0);
	
	tem = BasketballRobot.Vy;
	if(tem<0)
	{
		tem = -tem;
		LCD_ShowChar(60,300,'-',16,0);
	}
	else
	{
		LCD_ShowChar(60,300,' ',16,0);
	...
	integer = (u32)tem;
	decimal = (u32)((tem-integer)*1000);
	LCD_ShowxNum(90,300,integer,3,16,0);
	LCD_ShowChar(90+25,300,'.',16,0);
	LCD_ShowxNum(90+36,300,decimal,3,16,0);
	
	tem = BasketballRobot.W;
	if(tem<0)
	{
		tem = -tem;
		LCD_ShowChar(60,320,'-',16,0);
	}
	else{
		LCD_ShowChar(60,320,' ',16,0);
	}
	integer = (u32)tem;
	decimal = (u32)((tem-integer)*1000);
	LCD_ShowxNum(90,320,integer,3,16,0);
	LCD_ShowChar(90+25,320,'.',16,0);
	LCD_ShowxNum(90+36,320,decimal,3,16,0);
				
}

//显示X,Y,theta位置
void LCD_Show_position(void)
{
	float tem;
	u16 integer=0,decimal=0;
	...
	integer = (u32)tem;
	decimal = (u32)((tem-integer)*1000);
	LCD_ShowxNum(130,340,integer,3,16,0);
	LCD_ShowChar(130+25,340,'.',16,0);
	LCD_ShowxNum(130+36,340,decimal,3,16,0);
	
	tem = BasketballRobot.Y;
	if(tem<0)
	{
		tem = -tem;
		LCD_ShowChar(100,360,'-',16,0);
	}
	else{
		LCD_ShowChar(100,360,' ',16,0);
	}
	integer = (u32)tem;
	decimal = (u32)((tem-integer)*1000);
	LCD_ShowxNum(130,360,integer,3,16,0);
